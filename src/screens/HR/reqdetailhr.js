...
export default class reqdetailhr extends Component {
  constructor(props) {
    super(props);
    ...
    Resource.deteleLeave(id)
      .then((res) => {
        Alert.alert(
          ...
          'Press OK to Home',
          [
            { text: 'OK', onPress: () => this.props.navigation.navigate("MainScreenHR") },
          ],
          { cancelable: false },
        );
    ...
    return (
      <View>
        <View style={myStyles.TouchableOpacityStyle}>
          <TouchableOpacity onPress={() => this.props.navigation.navigate("EditScreenHR", { data: this.data })}>
            <View>
